...
import { Divider, Typography } from 'manyid';
...
const App: React.FC = () => (
  <Typography>
    ...
    <Paragraph>
      After massive project practice and summaries, Manyi Design, a design language for background
    ...
    <Paragraph>
      ...
      Manyi Design。基于<Text mark>『确定』和『自然』</Text>
