...
describe('Drawer', () => {
  ...
  it('test legacy afterVisibleChange', async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith(
      'Warning: [manyid: Drawer] `visible` is deprecated, please use `open` instead.',
    );
    expect(errorSpy).toHaveBeenCalledWith(
      'Warning: [manyid: Drawer] `afterVisibleChange` is deprecated, please use `afterOpenChange` instead.',
    );
